...
public class StartSceneButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler
{
    ...
    public void OnButtonClicked()
    {
        ...
        {
            fadeImage.gameObject.SetActive(true); // 페이드 이미지 활성화
            StartCoroutine(FadeOutAndLoadScene()); // 페이드 아웃 후 씬 로드
        }
    }

    // 버튼 클릭 시 실행될 페이드 아웃 및 씬 로드 코루틴
